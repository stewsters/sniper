...
public class WinScreen implements Screen {
    ...
    public WinScreen(SniperGame sniperGame) {
    ...
    public void render(float delta) {
        ...
        TextureManager.bitmapFont.draw(spriteBatch, "You Win. Press space to restart.", hudCamera.viewportWidth / 4f, hudCamera.viewportHeight / 2f);
