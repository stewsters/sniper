...
import com.stewsters.sniper.pathfinder.DoorDiggerMover;
...
import static com.stewsters.sniper.map.TileType.AIR;
import static com.stewsters.sniper.map.TileType.CLOSED_DOOR;
import static com.stewsters.sniper.map.TileType.CONCRETE_FLOOR;
import static com.stewsters.sniper.map.TileType.CONCRETE_WALL;
import static com.stewsters.sniper.map.TileType.DIRT_WALL;
import static com.stewsters.sniper.map.TileType.DOWN_STAIR;
import static com.stewsters.sniper.map.TileType.GLASS;
import static com.stewsters.sniper.map.TileType.GRASS;
import static com.stewsters.sniper.map.TileType.OPEN_DOOR;
import static com.stewsters.sniper.map.TileType.ROAD_FLOOR;
import static com.stewsters.sniper.map.TileType.SIDEWALK_FLOOR;
import static com.stewsters.sniper.map.TileType.UP_STAIR;
